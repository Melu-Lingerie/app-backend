...
public class WishlistValidationService {
    ...
    public void validateAddToWishlistRequestOrCollect(AddItemToWishlistRequestDto request, ValidationErrors errors) {
        if (request == null) {
    ...
    public void validateAddWishlist(Long userId, AddItemToWishlistRequestDto request, Wishlist wishlist,
