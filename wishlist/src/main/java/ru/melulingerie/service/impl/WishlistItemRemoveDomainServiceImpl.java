...
public class WishlistItemRemoveDomainServiceImpl implements WishlistItemRemoveDomainService {
    ...
    public void removeWishlistItem(Long userId, Long itemId) {
        ...
        removeWishlistItemInternal(item);

        log.info("Wishlist item removed successfully for userId: {}, itemId: {}", userId, itemId);
    }

    protected void removeWishlistItemInternal(WishlistItem item) {
